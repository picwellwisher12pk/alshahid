          ...
          <div className="space-y-8">
            <div className="space-y-6">
              <div className="inline-flex items-center space-x-2 bg-white/20 rounded-full px-4 py-2 text-sm">
                ...
                <span>Limited Time: Free Trial Class</span>
              </div>
              ...
              <p className="text-xl text-white/90 max-w-2xl mx-auto leading-relaxed">
                Take the first step towards mastering Quran recitation and Tajweed. 
                Book your free trial class today and experience the difference personalized learning makes.
              </p>
            </div>
            
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="space-y-4">
                <h3 className="text-xl mb-4">What's included in your free trial:</h3>
              ...
              <div className="space-y-6">
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                  ...
                  <div className="text-3xl mb-2 line-through text-white/60">$25</div>
                  <div className="text-4xl mb-4">FREE</div>
                  <Button 
                    size="lg" 
